  ...
  return (
    <>
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-[var(--text-secondary)]">Free forever. No credit card required.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          ...
          <input type={showPw ? 'text' : 'password'} placeholder="Password (min 8 chars)" value={password} onChange={e => setPassword(e.target.value)} required minLength={8}
          ...
          <button type="button" onClick={() => setShowPw(v => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--text-muted)]">
